...
items = [
    {
        'name':  'Fried Chicken',
        'image': 'http://aburayaoakland.com/wp-content/uploads/2020/05/IMG_4815.jpg',
    ...
    {
        'name':  'Wasabi Slaw',
        'image': 'http://aburayaoakland.com/wp-content/uploads/2020/05/IMG_4363-e1589343504189.jpg',
        'description': 'Coleslaw with wasabi oil.',
        'price': 4.00,
        'category_id': cat3.id 
    ...
    user1 = User.create(first_name: 'test', last_name: 'test', email: 'test@test.com', phone_number:'1234567890', password_digest:'abc123')